...
export default function AppLogoIcon(props: SVGAttributes<SVGElement>) {
    return (
        <svg {...props} fill="#000000" height="30px" width="20px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 27 25">
        <g>
	        <g id="c179_text">
